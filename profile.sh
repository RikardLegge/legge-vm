...
mkdir -p tmp/profile
sudo dtrace -c './target/release/main tmp/large.bc' -o ./tmp/profile/out.stacks -n 'profile-997 { @[ustack()] = count(); }'
...
"$flamegraphdir/flamegraph.pl" ./tmp/profile/out-short.folded > ./tmp/profile/out.svg
